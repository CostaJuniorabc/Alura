...
function exibirPrompt () {
    ...
    console.log(`Digite o nome de uma cidade do Brasil que você gosta muito: ${nomeCidade}`)
    alert(`Esative em ${nomeCidade} e lembrei de você`)
}

// 6 - Ao clicar no botão soma, peça 2 números e exiba o resultado da soma em um alerta.
function somandoDoisNumeros() {
    let primeiroNumero = parseInt(prompt(`Digite o primeiro número`))
    console.log(`Digite o primeiro número ${primeiroNumero}`)
    let segundoNumero = parseInt(prompt(`Digite o segundo número`))
    console.log(`Digite o segundo número ${segundoNumero}`)
